...
public class S3Controller {
    ...
    public ResponseEntity<Void> createObject(@PathVariable String nomeDoBucket, @RequestBody S3Model representation, @RequestParam boolean publicObject) throws IOException {
        s3Service.putObject(nomeDoBucket, representation, publicObject);
        return ResponseEntity.status(HttpStatus.CREATED).build();
    }
